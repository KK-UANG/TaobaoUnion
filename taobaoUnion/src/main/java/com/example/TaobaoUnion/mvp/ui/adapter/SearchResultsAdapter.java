...
public class SearchResultsAdapter extends BaseQuickAdapter<SearchResult.DataBean.TbkDgMaterialOptionalResponseBean.ResultListBean.MapDataBean, BaseViewHolder>  {
    ...
    @Override
    protected void convert(@NonNull BaseViewHolder helper, SearchResult.DataBean.TbkDgMaterialOptionalResponseBean.ResultListBean.MapDataBean item) {
